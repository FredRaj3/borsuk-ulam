...
Criteria repository for the Problem Market group **"Borsuk–Ulam in Lean"**, posed by Fred Rajasekaran.

3 locked Lean 4 statements awaiting proofs:

| Board | File | Target |
|---|---|---|
| CircleCase | `CircleCase.lean` | `CircleCase.borsuk_ulam_circle` |
| BorsukUlam | `BorsukUlam.lean` | `BorsukUlam.borsuk_ulam` |
| HamSandwich | `HamSandwich.lean` | `HamSandwich.ham_sandwich` |
